...
"[project]/src/api/index.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const login = async (userDataLogin)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$index$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/auth/login", userDataLogin);
...
const register = async (userDataRegist)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$index$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/auth/register", userDataRegist);
        return response.data;
    } catch (error) {
...
const profile = async (token)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$index$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/auth/profile", {
            headers: {
...
//# sourceMappingURL=src_11cdac6c._.js.map